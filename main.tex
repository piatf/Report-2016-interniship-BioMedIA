...
Cette partie du rapport va présenter la bibliothèque ArrayFire, ainsi que son intégration dans le MIRTK.
	...
	Ces quelques fonctions reflètent la forme de l'interface d'ArrayFire, mais ne représentent en aucun cas une liste exhaustive des fonctions disponibles. 
