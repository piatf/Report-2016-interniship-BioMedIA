...
#include <cstdio>
#include <cstdlib>
// A prelimibnary test has been done to check whether the matrix is square and symmteric or not
af::array EigenValuesSolver(af::array &in) // the input is an array
{
	...
	do
	{
		...
		af::max(&maxi, &index, temp);  diagonal
