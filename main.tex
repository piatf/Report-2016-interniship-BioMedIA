...
%	Cette partie est ta description du plan d'experience qui va amener les resultats.
%	
%	I faut donc dans l'ordre:
%	- presenter valgrind
%	- montrer comment il s'utilise
%	- montrer comment generer les resultats (pas les interpreter par contre ! Ca c'est apres)
%	- detailler le hardware sur lequel le profilage a ete fait
